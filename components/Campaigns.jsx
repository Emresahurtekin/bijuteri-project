  ...
  return (
    <div className="bg-secondary flex-1 rounded-md py-5 px-[15px] flex items-center gap-x-4">
      ...
      <div className="text-white">
        <Title addClass="text-2xl">Çılgın Perşembe</Title>
        <div className="font-dancing my-1">
          <span className="text-[40px]">40% İndirim </span>
          <span className="text-sm inline-block ml-1"></span>
        </div>
