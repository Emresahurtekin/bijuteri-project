...
const handleCreate = async () => {
  ...
  data.append("upload_preset", "bijuteri-project");

  try {
    const uploadRes = await axios.post(
      "https://api.cloudinary.com/v1_1/drszajo8y/image/upload",
      data
    );
          ...
          <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            ...
            <label className="flex gap-2 items-center">
                <input
                  ...
                  className="hidden"
                />
                <button className="btn-primary !rounded-none bg-primary pointer-events-none">
                  Fotoğraf Ekle
               </button>
              </label>
            </div>
