...
const Header = () => {
  ...
  return (
    ...
    className={`h-[5.5rem] z-50 relative w-full ${
      router.asPath === "/" ? "bg-transparent" : "!bg-primary !fixed"
      }`}
    >
      <div className="container mx-auto text-black flex justify-between items-center h-full">
        <Logo />
        <nav
          className={`sm:static absolute top-0 left-0 sm:w-auto sm:h-auto w-full h-screen sm:text-black text-black sm:bg-transparent bg-black sm:flex hidden z-50  ${
        ...
        <FaUserAlt
          ...
          <a href="#" className="md:inline-block hidden sm"></a>
